...
import { GROUPS, SCREENS, FLOWS, STATES, COMPONENT_GROUPS } from './data.js?v=23882a2c';
import { MOBILE, ph, pin, hot, bars, chip, badge, btn, pcard, header, bottomnav,
         edPh, edP, ico } from './wire.js?v=23882a2c';
import { DESKTOP } from './wire-desktop.js?v=23882a2c';
import { initInteractions, signPage } from './interact.js?v=23882a2c';
